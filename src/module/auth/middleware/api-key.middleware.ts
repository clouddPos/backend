...
export class ApiKeyMiddleware implements NestMiddleware {
  ...
  async use(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    ...
    console.log(
      '[ApiKeyMiddleware] API key value:',
      apiKey ? (apiKey as string).substring(0, 10) + '...' : 'none',
    );
    ...
    console.log(
      '[ApiKeyMiddleware] Config pos.apiKey:',
      validApiKey ? validApiKey.substring(0, 10) + '...' : 'none',
    );
